...
// export function check(_values: ListViewSelectionPreviewProps): Problem[] {
...
// export function getPreview(values: ListViewSelectionPreviewProps, isDarkMode: boolean): PreviewProps {
...
// export function getCustomCaption(values: ListViewSelectionPreviewProps, platform: Platform): string {
